      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-between md:flex-row">
          <div className="mb-4 md:mb-0">
            <video />
            <h2 className="-center text-xl font-bold text-white">Los Valera</h2>
          ...
          <div className="mx-auto flex flex-col gap-4 md:flex-row md:gap-8">
            {/*   Nav Links   */}
            <LinkPreview url={"/"}>INICIO</LinkPreview>
            <a
              href="#"
        ...
        <div className="flex flex-col items-center justify-between text-sm md:flex-row">
          <p>
            ...
            <span className="font-bold">Los Valera</span>. Todos los derechos
            reservados.
          </p>
